...
%need to change
ResultDir='C:\Users\alizades\Google Drive\Master\Code\libviso2 - Copy\matlab\Results-Tr-fig\06\';
DataDir='C:\Users\alizades\Google Drive\Master\Code\Data\data_odometry_gray-httpwww.cvlibs.netdatasetskittieval_odometry.php\dataset\sequences\06\';
GPSdir='C:\Users\alizades\Google Drive\Master\Code\Data\data_odometry_gray-httpwww.cvlibs.netdatasetskittieval_odometry.php\data_odometry_poses\dataset\poses\06.txt';
...
Q           = diag([1e-8*ones(1,6) 1e-12*ones(1,6)]);%diag(q);%Process Noise cov. matrix
...
xhat  = ExtnddKalmanFilter( N_k,S_k,x_0,P_0,F,H,Q,R,z );
