...
//The arrow (->) in C++ is just an easier way to write a dot operator. 
//To access something a pointer points to. It's a combination of de-referencing and member access.
//Example: Instead of (*hello).world, you can write hello->world;
